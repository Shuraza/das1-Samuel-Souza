...
- Poder utilizar o conhecimento acumulado para seguir em carreiras relacionadas a tecnologia (não necessariamente eng de software), poder desenvolver projetos pessoais e corporativos com uma direção clara de quais ações precisam ser tomadas para o mesmo ser desenvolvido, saber os escopos e direções que posso tomar dentro da área da tecnologia e, por fim, poder fazer um pós na área que desejar. 

- Poder identificar e tomar as melhores decisões com base em exemplos prévios vistos em aula para poder fazer um sistema rápido, seguro e robusto. Também poder utilizar esse conhecimento em entrevistas futuras.
